...
const CustomerManagementSection = ({ data: dataSaved, isReadOnly }) => {
  const {
  ...
  return (
    <div className="border p-4 rounded-lg">
      ...
      <div className="flex items-center mb-2">
        ...
        <select
          value={isReadOnly ? data['PERSONA COMERCIAL'] : directorComercial}
      ...
      <div className="flex items-center mb-2">
        ...
        <select
          value={isReadOnly ? data['PERSONA SERVICIO AL CLIENTE'] : servicioAlCliente}
      ...
      <div className="col-span-1">
        ...
        <textarea
          value={isReadOnly ? data['Observiaciones'] : comentariosDetalle}
